...
const Sell = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.post(API_PATHS.CAR.CREATE_CAR, data, {
      ...
      toast.error('Error listing car. Please try again.');
      console.error(err);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 p-6 bg-white rounded shadow-md">
      <Toaster />
      <h2 className="text-3xl font-bold mb-6 text-center">Sell Your Car</h2>
